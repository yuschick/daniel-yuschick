const data = [
  {
    title: "Born and raised in Pennsylvania, USA",
    content: [
  ...
  {
    title: "Moved to North Carolina, USA in 2009",
    content: [
  ...
  {
    title: "Followed my love of winter and metal to Helsinki, Finland in 2017",
    content: [
